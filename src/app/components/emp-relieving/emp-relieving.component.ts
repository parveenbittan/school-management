...
@Component({
  selector: 'app-emp-relieving',
  templateUrl: './emp-relieving.component.html',
  styleUrl: './emp-relieving.component.css'
})
export class EmpRelievingComponent  implements OnInit{
  //board: ComesUnder,
